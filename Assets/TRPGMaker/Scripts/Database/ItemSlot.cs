...
public class ItemSlot : Slot {
    ...
    public new void setModifier(Modifier modifier)
    {
    ...
    public new Boolean canEquip(Modifier modifier)
    {
        Character character = GameObject.Find("Character").GetComponent<Character>();
        ...
        // Comprobamos si en alguno de las combinaciones del item donde est� este tipo de slot puede
