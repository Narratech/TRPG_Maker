...
[CustomEditor(typeof(Database), true, isFallback = true)]
...
public class CustomEditorBase : Editor
{
    ...
    protected void HandleArray(SerializedProperty property)
    {
        ...
        if ((!listData.IsExpanded.value && !listData.IsExpanded.isAnimating) || (!listData.IsExpanded.value && listData.IsExpanded.isAnimating))
        {
            ...
            property.isExpanded = EditorGUILayout.ToggleLeft(string.Format("{0} (Size: {1})", property.displayName, property.arraySize), property.isExpanded, EditorStyles.boldLabel);
