...
public class Database : ScriptableObject, ISerializationCallbackReceiver
    ...
    Dictionary<string,List<string>> _tags;  // Tags per template. Example: _tags["Item"]["Weapon"] returns "Weapon"
    
    // Serializable Database elements
    [SerializeField]
    private List<Attribute> _attributesList;  // Every Attribute in Database in List format
    [SerializeField]
    ...
    public static Database Instance
        ...
        get { return instance == null ? instance=UnityEditor.AssetDatabase.LoadAssetAtPath<Database>("Assets/database.asset") : instance; }
        }
    ...
    public void createDemoDatabase()
        ...
        Attribute damage=new Attribute(false,"dmg","Damage","Base damage points",1,10000);
        Attribute fireDamage=new Attribute(false,"fdg","Fire damage","Fire damage points",1,10000);
        Attribute iceDamage=new Attribute(false,"idg","Ice damage","Ice damage points",1,10000);
        Attribute defense=new Attribute(false,"def","Defense","Defense points",1,10000);
        Attribute fireDefense=new Attribute(false,"fdf","Fire defense","Fire defense points",1,10000);
        Attribute iceDefense=new Attribute(false,"idf","Ice defense","Ice defense points",1,10000);
        ...
        Debug.Log("Demo database created!");
        }
    ...
    public void OnAfterDeserialize()
        ...
        {
        _attributes = new Dictionary<string, Attribute>(); 
        _attributesList.ForEach(a => _attributes.Add(a.name, a));
    ...
    public bool addAttribute(Attribute atr)
        // Tries to add a new Attribute to the database and informs about it
        {
    ...
    public bool deleteAttribute(string atr)
        // Tries to delete an existing Attribute from the database and informs about it
        {
