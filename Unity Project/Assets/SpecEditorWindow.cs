...
public class SpecEditorWindow: EditorWindow
    {
    // Constants
    private static int MAX_FORMULAS=100;
    private static int MAX_SLOTS=100;
    // Wizard
    private int step;
    // Basics
    string specName;
    ...
    // Database
    // Hay que tener una instancia de la base de datos por referencia para poder volcar el SpecModifier
    //private DatabaseTest db;
    // Hay que hacer una clase SpecModifier
    //private SpecModifier currentSpec = new SpecModifier();
    ...
    void OnGUI()
        ...
        switch (step)
            ...
            case 0:
                ...
                //GUILayout.BeginArea(new Rect((Screen.width/2)-250,(Screen.height/2),500,200));
