...
namespace IsoUnity
{
    ...
    {
        [System.Serializable]
        public class VirtualNeighbor
        {
            public Mover.Direction OutputDirection;
            public Mover.Direction InputDirection;
            public Cell Destination;
        }

        [SerializeField]
        private List<VirtualNeighbor> virutalNeighbors = new List<VirtualNeighbor>();
        public List<VirtualNeighbor> VirtualNeighbors { get { return virutalNeighbors; } }
        ...
        public List<Entity> Entities { get { return new List<Entity>(GetComponentsInChildren<Entity>()); } }
        [SerializeField]
        private List<Entity> influences = new List<Entity>();
        public List<Entity> Influences { get { return influences; } }
