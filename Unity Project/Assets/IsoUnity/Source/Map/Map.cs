...
namespace IsoUnity
{
    ...
    public class Map : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public Cell[] getNeightbours(Cell c)
        {
            ...
            foreach(var virtualNeighbor in c.VirtualNeighbors)
            {
                vecinas[c][(int)virtualNeighbor.OutputDirection] = virtualNeighbor.Destination;
            }
        ...
        {
            return cellMap.ContainsKey(vector) ? cellMap[vector] : null;
        }
